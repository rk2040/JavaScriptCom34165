...
function mostrarLista(lista){
    ...
    {
        document.getElementById("cuerpoTabla").innerHTML += '<tr> <td>' + lista[i].nombre + '</td><td>' + lista[i].zona + '</td><td>' + lista[i].comuna + '</td><td>' + lista[i].precio + '</td> </tr>';
    }
    return lista;
}
// ------------------------------------------------------------------------
...
function calcularSuperficie(medida1, medida2) {
    ...
    if( areaRectangulo < 1 || areaRectangulo == null || isNaN(areaRectangulo))
...
function calcularSuperficieCirculo(medida1, medida2) {
    ...
    if( areaCirculo < 1 || areaCirculo == null || isNaN(areaCirculo) )
        document.getElementById("mensajeError").innerHTML = "No se pudo calcular porque falta alguno de los valores.";
...
function calcularValorTotal(num1, num2) {
    ...
    if( resultado < 1 || resultado == null || isNaN(resultado))
        document.getElementById("mensajeError").innerHTML = "No se pudo calcular porque falta alguno de los valores.";
...
function mostrarValorTotal(){
    ...
    document.getElementById("valorRectangulo").value = calcularValorTotal(metroRectangulo, precio).toFixed(2);
    document.getElementById("valorCirculo").value = calcularValorTotal(metroCirculo, precio).toFixed(2);
}
// ------------------------------------------------------------------------
// ------------------------------------------------------------------------
