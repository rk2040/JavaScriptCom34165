...
//----------------------------------
// Botones Operaciones
btnOperaciones.innerHTML += `<button class="calcular" type="button" id="mts2" onclick="mostrarMts2(this.id)">Calcular Mts2</button>`;
btnOperaciones.innerHTML += `<button class="calcular" type="button"  id="valorTotal" onclick="mostrarValorTotal(this.id)">Calcular total en US$</button>`;
btnOperaciones.innerHTML += `<button class="borrar" type="button" id="reset" onclick="borrar()">Reset</button>`;
//----------------------------------
